...
//            System.out.println("6. Collect Order");
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    cart.checkout(); //just for payment only
                    OrderItem newOrder = new OrderItem(cart.getCartID());
                    //OrderItem order = new OrderItem(cart.getCartID(), order.setOrderStatus());
//                	order.toString();
...
//                    break;
    ...
    private static int generateCartId() {
        // Simple example: generate a random ID. In a real application, this should ensure uniqueness and consistency with your data storage.
